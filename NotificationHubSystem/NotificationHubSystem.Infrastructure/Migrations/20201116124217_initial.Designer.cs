...
namespace NotificationHubSystem.Infrastructure.Migrations
{
    ...
    [Migration("20201116124217_initial")]
            ...
            modelBuilder.Entity("NotificationHubSystem.Core.Entities.NotificationType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2020, 11, 16, 14, 42, 16, 766, DateTimeKind.Local).AddTicks(6367),
                            DeleteStatus = 0,
                            Name = "Mail"
                        },
                        new
                        {
                            Id = 2,
                            CreationDate = new DateTime(2020, 11, 16, 14, 42, 16, 766, DateTimeKind.Local).AddTicks(6654),
                            DeleteStatus = 0,
                        ...
                        {
                            Id = 3,
                            CreationDate = new DateTime(2020, 11, 16, 14, 42, 16, 766, DateTimeKind.Local).AddTicks(6693),
                            DeleteStatus = 0,
                            Name = "SMS"
                        });
                });
            ...
            modelBuilder.Entity("NotificationHubSystem.Core.Entities.SendingStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2020, 11, 16, 14, 42, 16, 763, DateTimeKind.Local).AddTicks(4524),
                            DeleteStatus = 0,
                            Name = "New"
                        },
                        new
                        {
                            Id = 2,
                            CreationDate = new DateTime(2020, 11, 16, 14, 42, 16, 766, DateTimeKind.Local).AddTicks(3242),
                            DeleteStatus = 0,
                            Name = "Success"
                        },
                        new
                        {
                            Id = 3,
                            CreationDate = new DateTime(2020, 11, 16, 14, 42, 16, 766, DateTimeKind.Local).AddTicks(3516),
                            DeleteStatus = 0,
                            Name = "Failed"
                        });
                });
