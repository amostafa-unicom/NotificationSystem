...
namespace NotificationHubSystem.Infrastructure.Migrations
{
    ...
    [Migration("20201116134123_notificationTokenId")]
    partial class notificationTokenId
    {
            ...
            modelBuilder.Entity("NotificationHubSystem.Core.Entities.NotificationType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2020, 11, 16, 15, 41, 22, 682, DateTimeKind.Local).AddTicks(7154),
                            DeleteStatus = 0,
                            Name = "Mail"
                        },
                        new
                        {
                            Id = 2,
                            CreationDate = new DateTime(2020, 11, 16, 15, 41, 22, 682, DateTimeKind.Local).AddTicks(7474),
                            DeleteStatus = 0,
                        ...
                        {
                            Id = 3,
                            CreationDate = new DateTime(2020, 11, 16, 15, 41, 22, 682, DateTimeKind.Local).AddTicks(7509),
                            DeleteStatus = 0,
                            Name = "SMS"
                        });
                });
            ...
            modelBuilder.Entity("NotificationHubSystem.Core.Entities.SendingStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2020, 11, 16, 15, 41, 22, 680, DateTimeKind.Local).AddTicks(873),
                            DeleteStatus = 0,
                            Name = "New"
                        },
                        new
                        {
                            Id = 2,
                            CreationDate = new DateTime(2020, 11, 16, 15, 41, 22, 682, DateTimeKind.Local).AddTicks(4344),
                            DeleteStatus = 0,
                            Name = "Success"
                        },
                        new
                        {
                            Id = 3,
                            CreationDate = new DateTime(2020, 11, 16, 15, 41, 22, 682, DateTimeKind.Local).AddTicks(4551),
                            DeleteStatus = 0,
                            Name = "Failed"
                        });
                });
