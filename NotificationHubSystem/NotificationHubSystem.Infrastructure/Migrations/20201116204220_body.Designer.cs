            ...
            modelBuilder.Entity("NotificationHubSystem.Core.Entities.NotificationType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2020, 11, 16, 22, 42, 20, 53, DateTimeKind.Local).AddTicks(5633),
                            DeleteStatus = 0,
                            Name = "Mail"
                        },
                        new
                        {
                            Id = 2,
                            CreationDate = new DateTime(2020, 11, 16, 22, 42, 20, 53, DateTimeKind.Local).AddTicks(5998),
                            DeleteStatus = 0,
                        ...
                        {
                            Id = 3,
                            CreationDate = new DateTime(2020, 11, 16, 22, 42, 20, 53, DateTimeKind.Local).AddTicks(6065),
                            DeleteStatus = 0,
                            Name = "SMS"
                        });
                });
            ...
            modelBuilder.Entity("NotificationHubSystem.Core.Entities.SendingStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2020, 11, 16, 22, 42, 20, 50, DateTimeKind.Local).AddTicks(1217),
                            DeleteStatus = 0,
                            Name = "New"
                        },
                        new
                        {
                            Id = 2,
                            CreationDate = new DateTime(2020, 11, 16, 22, 42, 20, 53, DateTimeKind.Local).AddTicks(1970),
                            DeleteStatus = 0,
                            Name = "Success"
                        },
                        new
                        {
                            Id = 3,
                            CreationDate = new DateTime(2020, 11, 16, 22, 42, 20, 53, DateTimeKind.Local).AddTicks(2272),
                            DeleteStatus = 0,
                            Name = "Failed"
                        });
                });
