...
namespace NotificationHubSystem.Core.UseCases.Notification.NotificationGetNewUseCase
{
    internal class NotificationGetNewUseCase : BaseUseCase, INotificationGetNewUseCase
    {
        ...
        public async Task<bool> HandleUseCase(IOutputPort<ResultDto<NotificationGetNewOutputDto>> _response)
        {
            ...
            {
                _response.HandlePresenter(new ResultDto<NotificationGetNewOutputDto>(Mapping(notifications)));
            }else
